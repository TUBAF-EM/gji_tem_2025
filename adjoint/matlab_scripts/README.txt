...
Then run analytic_e_field_grid.m again to produce the adjoint fields on a regular grid using a small source or a VMD.
...
The installation of empymod is a prerequisite for running analytic_e_field_grid.m. Note that the E-fields can be calculated by any other routine, particularly also using FEMALY. 
